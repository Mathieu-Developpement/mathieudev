...
const fakeReviews: Review[] = [
  ...
  },
  {
    ...
    message: "Mathieu a développé une application mobile pour notre centre. Réservation de cours, suivi des membres, notifications. Tout fonctionne parfaitement! Notre équipe l'utilise chaque jour !",
    rating: 5,
