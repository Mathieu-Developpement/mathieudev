...
const fakeReviews: Review[] = [
  {
    ...
    message: "Organix a complètement transformé ma façon de travailler. Avant, j'organisais mes fichiers Rush à la main pendant 30 à 45 minutes par projet. Maintenant c'est automatique dès que je reçois un Drive partagé. Mathieu a vraiment pensé au workflow d'un monteur.",
    rating: 5,
    created_at: "2025-05-20",
  },
  {
    id: -2,
    name: "Frédéric Beausoleil",
    role: "Monteur vidéo, Productions Nord",
    message: "J'utilisais Organix depuis quelques semaines et je ne peux plus m'en passer. La synchronisation locale et la décompression automatique des archives me font gagner un temps fou sur chaque projet.",
    rating: 5,
  ...
  },
  {
    id: -3,
    name: "Thomas Girard",
    role: "Entrepreneur, secteur construction",
    message: "SoumiPro a changé la façon dont je prépare mes soumissions. En quelques secondes, j'ai un document professionnel prêt à envoyer. Avant je passais des heures là-dessus. L'IA comprend vraiment mon domaine.",
    rating: 5,
  ...
  },
  {
    id: -4,
    name: "Nadia Fortin",
    role: "Travailleuse autonome, rénovation",
    message: "Je recommande SoumiPro à tous mes collègues entrepreneurs. Plus besoin de partir d'une feuille blanche pour chaque soumission. L'IA génère une base solide que j'ajuste en 5 minutes.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Propriétaire, Clinique vétérinaire",
    message: "Mathieu a développé un système de gestion interne sur mesure pour notre clinique. Ça a transformé notre quotidien. Professionnel, à l'écoute et très compétent.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Directeur IT, PME québécoise",
    message: "Nous avons fait appel à Mathieu pour un logiciel de gestion interne. Résultat livré en moins de 3 semaines, sans frais de développement. Le modèle d'abonnement nous a permis de tester sans risque. On s'est abonnés sans hésiter.",
    rating: 5,
  ...
  },
  {
    ...
    name: "Maëlle Côté",
    role: "Coach en ligne",
    message: "Mathieu a intégré un assistant IA dans mon site pour qualifier mes leads automatiquement. Je ne peux pas tout divulguer sur la solution, mais les résultats parlent d'eux-mêmes : mes conversions ont doublé en deux mois.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Entrepreneur, projet confidentiel",
    message: "Le modèle sans frais de développement m'a permis de lancer un projet que j'avais en tête depuis longtemps sans prendre de risque financier. Mathieu livre ce qu'il promet. Simple, efficace, professionnel.",
    rating: 5,
  ...
  },
  {
    ...
    message: "Mon portfolio en ligne est exactement ce que j'imaginais. Rapide, élégant, et mon formulaire de contact convertit vraiment. J'ai eu 3 nouveaux clients le premier mois. Le tout sans débourser un dollar à la livraison.",
    rating: 5,
  ...
  },
  {
    id: -10,
    name: "Simon Gagnon",
    role: "Propriétaire, centre de conditionnement",
    message: "Mathieu a développé une application mobile pour notre centre. Réservation de cours, suivi des membres, notifications. Tout fonctionne parfaitement! Je ne peux pas partager l'app publiquement, mais notre équipe l'utilise chaque jour.",
    rating: 5,
