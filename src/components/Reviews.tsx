          ...
          {showForm && !submitted && (
            <div className="max-w-lg mx-auto glass-card rounded-2xl p-8 text-left mt-8">
              ...
              <div className="flex flex-col gap-4">
                <div>
                  <label htmlFor="review-name" className="text-xs text-[#999] uppercase tracking-widest mb-1 block">
                    Ton prénom *
                  </label>
                ...
                <div>
                  <label htmlFor="review-role" className="text-xs text-[#999] uppercase tracking-widest mb-1 block">
                ...
                <div>
                  <label className="text-xs text-[#999] uppercase tracking-widest mb-2 block">
                    Note
                  </label>
                  <StarRating
                    rating={form.rating}
                ...
                <div>
                  <label htmlFor="review-message" className="text-xs text-[#999] uppercase tracking-widest mb-1 block">
                    Ton message *
                  </label>
                  <textarea
                    id="review-message"
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    aria-label="Annuler et fermer le formulaire d'avis"
                  >
                    Annuler
                  </button>
                </div>
